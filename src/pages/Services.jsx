...
// Main Skyra services with updated pricing and custom button text
const mainServices = [
  {
    title: "Weddings",
    slug: "weddings",
...
// Expandable services with updated pricing and custom button text
const additionalServices = [
  {
    title: "House Warming Ceremonies",
    slug: "housewarming",
...
const Services = () => {
  ...
  return (
    <div>
      ...
      {/* Other Extra Services Section */}
      <section className="py-16 bg-light-purple">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl text-center font-bold font-playfair mb-12">Additional Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Additional services content here */}
          </div>
        </div>
      </section>
    </div>
